...
rl.on('line', (line) => {
	...
	if (line.split(' ')[0]==='about') {
        console.log(('[VERSION]').green + ('----Current Version: 1.0.2----').white);
		console.log(('[CREATOR]').green + (' AgarThix ').white);
		console.log(('[PROTOCOL]').green + ('Dont delete this file!').white);
    ...
    if (line==='help') {
		...
		console.log(('[HELP]').green + ('  Restart - Restart Bot').white);
